...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pypythia-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pypythia-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pythiaphylopredictor
# for installing globally
pixi global install pythiaphylopredictor
```
...
It is possible to list all of the versions of `pythiaphylopredictor` available on your platform:
...
```
pixi search pythiaphylopredictor --channel conda-forge
```
